        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#">
                    ...
                    <span>{{ __('Layout Options') }}</span>
                    <span class="pull-right-container">
                        <span class="label label-primary pull-right">4</span>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i> {{ __('Top Navigation') }}</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> {{ __('Boxed') }}</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Fixed') }} </a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>{{ __('Collapsed Sidebar') }} </a></li>
                </ul>
            </li>
            <li>
                <a href="#">
