                        ...
                        <ul class="menu">
                            <li>
                                <a href="#">
                                    ...
                                    <h4>
                                        {{ __('Support Team') }}
                                        <small><i class="fa fa-clock-o"></i> {{ __('5 mins') }}</small>
                                    </h4>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        <img src={{ asset('bower/AdminLTE/dist/img/user3-128x128.jpg') }} class="img-circle" alt="User Image">
                                    </div>
                                    <h4>
                            ...
                            <li>
                                <a href="#">
                                    <div class="pull-left">
                                        <img src={{ asset('bower/AdminLTE/dist/img/user4-128x128.jpg') }} class="img-circle" alt="User Image">
                                    </div>
                                    <h4>
                                        Developers
