...
<div class="content-wrapper" id="manager_bill">
    ...
    <div class="modal fade" id="showEditItem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content border-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <h3 class ="text-center"><i>{{ __('CREATE BILL') }}</i></h3>
                    <h4 class ="text-center">{{ __('FSalon 434 Tran Khat Chan') }}</h4>
                </div>
                <div class="modal-body" >
                    <form role="form">
                        <div class="form-group">
                            <label class="fix-label">{{ __('Name') }} </label>
                            <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                            <label class = "fix-label">{{ __('Phone') }}</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Phone">
                        </div>
                        <div class="form-group">
                            <label class = "fix-label">{{ __('Time') }}</label>
                            <input type="time" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label class = "fix-label">{{ __('Day') }}</label>
                            <input type="date" class="form-control" id="exampleInputPassword1" placeholder="Enter Phone">
                        </div>
                        <div class="form-group">
                            <label class = "fix-label">{{ __('Stylist') }}</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Name Stylist">
                        </div>
                        <div class="form-group">
                            <label class = "fix-label">{{ __('Department') }}</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Department">
                        </div>
                        <div class="form-group">
                            <label>{{ __('Service :') }}  </label>
                            <label class="checkbox-inline"><input type="checkbox" value="">{{__('Hair Cuts') }}</label>
                            <label class="checkbox-inline"><input type="checkbox" value="">{{__('Shampoo') }}</label>
                        </div>
