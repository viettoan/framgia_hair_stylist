                    ...
                    <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="createItem">
                        <div class="form-group">
                            ...
                            <label for="name">{{ __('Department') }}</label>
                                <div class="form-group">
                                    <select  class="form-control" id="sel1" v-model="newItem.department_id">
                            ...
                            <label for="name">{{ __('Gender') }}</label>
                                 <select  class="form-control" id="sel1" v-model="newItem.gender">
                            ...
                            <div class="col-sm-4">
                                <label for="name">{{ __('Permission') }}</label>
                                    <select  class="form-control" id="sel1" v-model="newItem.permission">
                             ...
                             <div class="col-sm-4">
                            <label for="name" id="specialize">{{ __('Specialize') }}</label>
                             </div>
